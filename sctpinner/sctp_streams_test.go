...
func TestStreams(t *testing.T) {
	...
	ln, err := ListenSCTPExt("sctpinner", addr, InitMsg{NumOstreams: STREAM_TEST_STREAMS, MaxInstreams: STREAM_TEST_STREAMS})
	if err != nil {
	...
	for ; i < STREAM_TEST_CLIENTS; i++ {
		go func(test int) {
			...
			conn, err := DialSCTPExt(
				"sctpinner", nil, addr, InitMsg{NumOstreams: STREAM_TEST_STREAMS, MaxInstreams: STREAM_TEST_STREAMS})
			if err != nil {
